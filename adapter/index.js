...
function static_vercel_config(builder, config, dir) {
	...
	const routes = [
		// Ensure remote functions are always handled by the catchall route
		// The stops them from being affected by ISR config from other routes that match /[...rest] (ref: #15085)
		{
			src: `/${builder.getAppPath()}/remote/.+`,
